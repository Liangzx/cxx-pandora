...
public:
  ...
  template <typename C> auto subtrie(const C &c) const {
...
int main() {
  ...
  trie<char> t;
  t.insert({'h', 'e', 'l', 'l', 'o', '0'});
  t.insert({'h', 'e', 'l', 'l', 'o', '1'});
  t.insert({'h', 'e', 'l', 'l', 'o', '2'});
  ...
  if (auto st(t.subtrie(initializer_list<char>{'h', 'e'})); st) {
    st->get().print();
  }
}
