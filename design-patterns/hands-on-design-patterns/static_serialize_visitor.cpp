...
template <typename G1, typename G2> class Intersection {
public:
...
template <typename T> void write(const T &t, std::ostream &out = std::cout) {
  StreamVisitor v(out);
  v(t);
}
...
template <typename T> void serialize(const T &t, std::string &s) {
...
template <typename V, typename T> void visitation(V &v, T &t) { v(t); }
template <typename V, typename T, typename... U>
void visitation(V &v, T &t, U &...u) {
  v(t);
  visitation(v, u...);
}
template <typename... U> void deserialize(const std::string &s, U &...u) {
...
template <typename... U> void serialize(char *buffer, size_t size, U &...u) {
...
template <typename... U> void deserialize(char *buffer, size_t size, U &...u) {
